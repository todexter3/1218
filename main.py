...
def main():
    if args.is_training == True:
        ...
        for args.tau_hat_init in [1.0,2.0,3.0,0.0]:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='data/daily_label10_data_202312.feather',
    ...
    parser.add_argument('--checkpoints', type=str, default='/cpfs/dss/dev/gzyu/DL_forecasting_stock/fore_PTST5/data/results/daily/y10/PatchTST_C_group_mult_speed_taskmultiple_regression_PatchTST_C_group_mult_speed_start_year2017_end_year2020_test_year2021_mlp32_lay2_kfoldTrue_seq120_pred1_freqd_ep60_bs256_early10_lr1e-05_wd1e-05_dp0.1_M_invFalse_dmo128_dff256_pl16_sr8_psphiyhis1.0', help='location of model checkpoints')
    ...
    # heiyi
    parser.add_argument('--save_path', type=str, default='results/', help='train start year')
    parser.add_argument('--train_start_year', type=str, default='2017', help='train start year')
    ...
    parser.add_argument('--tau_hat_init', type=float, default=1.0, help='tau_hat_init')
