...
parser.add_argument('--root_path', type=str, default='/cpfs/dss/dev/gzyu/DL_forecasting_stock/fore_PTST_b/',
...
parser.add_argument('--weight_decay', type=float, default=0.00001, help='weight decay value')
                    ...
                    #     for args.MLP_hidden in [64]:
                        ...
                        # for args.d_ff in [32,64,128]:
                                ...
                                # for args.pred_len in [1]:# [96, 192, 336, 720]
                                    ...
                                    args.train_log_dir = f'/cpfs/dss/dev/gzyu/DL_forecasting_stock/fore_PTST_b/logs/{args.loss}_sample_cross_section_{args.test_year}_dm{args.d_model}_sq{args.seq_len}'
